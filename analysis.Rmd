...
ggplot() +
  geom_path(data=caro9, aes(x=E, y=N), color="blue", size=0.4, linetype=2) +
  geom_path(data=caro, aes(x=E, y=N), color="orange", size=0.4, linetype=2) +
  labs(title="Path of different time sample intervals (1 min in orange and 9 min in blue)", x = "Easting", y = "Northing")

ggplot() +
  geom_path(data=caro6, aes(x=E, y=N), color="blue", size=0.4, linetype=2) +
  geom_path(data=caro, aes(x=E, y=N), color="orange", size=0.4, linetype=2) +
  labs(title="Path of different time sample intervals (1 min in orange and 6 min in blue)", x = "Easting", y = "Northing")

ggplot() +
  geom_path(data=caro3, aes(x=E, y=N), color="blue", size=0.4, linetype=2) +
  geom_path(data=caro, aes(x=E, y=N), color="orange", size=0.4, linetype=2) +
